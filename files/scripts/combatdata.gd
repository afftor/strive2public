...
descriptionambush = 'You are attacked by a $race monster $child!',
},
...
rewardgold = [5,10],
rewardexp = 20,
stats = {health = 55, power = 4, speed = 17, energy = 50, armor = 0, magic = 5, abilities = ['attack']},
skills = [],
},
harpy = {
name = 'Harpy',
...
capture = true,
capturerace = ['area'],
captureoriginspool = [{value = 'rich', weight = 1},{value = 'commoner', weight = 2},{value = 'poor', weight = 1}],
captureagepool = [{value = 'child', weight = 1},{value = 'teen', weight = 3}, {value = 'adult', weight = 4}],
capturesex = ['any'],
rewardpool = {},
rewardgold = [5,10],
