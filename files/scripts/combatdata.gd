...
description = "$scoutname spots a group of ginat spiders hiding in the shadows. ",
...
rewardsupply = {low = 1, high = 2},
rewardexp = 10,
stats = {health = 500, power = 15, speed = 16, energy = 50, armor = 20, magic = 2, abilities = ['attack','aoeattack']},
skills = [],
},
bosswyvern = {
name = 'Cave Wyvern',
...
rewardsupply = {low = 1, high = 2},
rewardexp = 10,
stats = {health = 450, power = 18, speed = 16, energy = 50, armor = 15, magic = 2, abilities = ['attack','aoeattack']},
skills = [],
},
}
