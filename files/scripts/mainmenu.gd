...
var five = ['destont','Solforward','Nik Shepherd','SlowBob','dudeman','Jake','Dat Tran','jezzjoker','mjorgey','Frendy','James A. Messick III','william taylor','Paul James','HentaiHeitai','1badmunkey','Zac Schneider',"Mim'n O'y",'Mike Hefner','krazygloo19','joseph rouse','DrD','Artem Klimov','Trisynth','Nebula Fox','Konomori','Aran Brewer','Benjamin','Mark Hilgenfeldt','Sabledean','Rakesh','Lorem.Ipsum','rhogleg','TenMinuteTom','Sean Templeton','jason debats','Andy','Kamiko Soulight','Spigot Frigate','Michael Hoover','Kyle Evans','u can do anything!','Just A Random Guy','Lukino','Guy Dude','hannah taylor','Doob','Kevinati','disappointingclimax','TheDevilYouKnow','Tobias','Ali Mutlu','J R','Jean-Sébastien Sirois','Nathaniel scheil','Marko Malkowski','aliquis','Demosbane','novastorm76','Marc Donner','Jarod','Lucas Ibister','random poster','James','Alexander','Yendor934','William Mason','Brendan Dore','JUSTIN','Nate A','Mr.A','DisturbJin','Bjørn Zederkof','markdavidson2062','Crazyblue','Garrett Griffin','Nathan Smith','CaptVix','Thoridin58','Cannon Koester','Sipcopata','ozxecho','John Pierce','Alexi','Fleming Folster','TimeFrame','Christian Anderson','Mirokasi','pfargtl','Drago Smith','Jens-Kristian Lindholm','Bravanger','Kevin Lane','P4Nd0RaS','Javier Otero','PB','James Ahlstrom','Shannon Stewart','Zekuro','Simins3','ladyhei','Thordain','Oldcityguy','madmand','Alice Carlan','Carl Miller','GeminiKnight82','CJ','jushawn marshall','Jules Sey','Rikkatyra','Aaron Johnson','Ccheev','Tom Hourie','trevor','Grinix','Beolwin Norgannon','Hentai','smokecatcher','GrimWolf','Kuroihana','Capt Nobody','Shawn McAuley','Brandon','Dane Newton','PE','Justanx','Joel Kitchen','David Johnson','Matt Miller','Vincent Gagnon','jacques','bioret ronan','Yojimbo','Mason Leonard','dempsey','Dominic Leach','Chris McCarthy','Jesse Swales','Tyler Wickline','Jim S','T R','Kaerea Shine','Bla','Aisha king','Nevyn','Massatsu','tyson chermishnok','Samuel Johansson','Evan Keever','Christopher Divry','Dafydd Christopher Huw Owen','Isaac Rummerfield','Grnd91','Norpuma','Horse With No Name','Jack Peverall','Greg M Skripsky', 'jordan lindsay', 'Julius Kingsley', 'D. A.', 'Michael Lewis', 'Nithilius', 'elvis', 'Clifton Wiederhold', 'pooky', 'Warren Monego II', 'Promenade', 'Klaus Trinks', 'thomas790', 'WalkingOnTheWater', 'Stephen Clifford', 'PinPig5', 'Rainef', 'Kurt', 'Eric H.', 'Scott', 'Marco Cattaido', 'lars nielsen', 'Sakido', 'john applesea', 'Timithios', 'Parker Mcqueen', 'Jonathan Garver', 'Reuben', 'Gullindjemprins', 'Cyrus53', 'Magetsu88', 'ScaredEnigma', 'qwertyuiop99999', 'Kaerea Shine', 'David Donnely', 'arkon', 'Woahman', 'Archie Black', 'Eric Brown', 'Bene', 'Erok', 'Lightness', 'DarkAntonius', 'John Kamasaki', 'Crette', 'Amy Tu', 'jonas', 'Callum Dunn', 'matthew c sisti', 'ZyGoat', 'Alex', 'JT', 'Knixi', 'Ayu Aikawa', 'Kubebzz', 'Litland', 'Jeremy Springer', 'Scott S.', 'overkill9', 'shdwfsh63', 'Wayne Shearer', 'Isaac Boyles', 'Marco Polo', 'Malcolm', 'Shuuu', 'kirk hamman', 'Soratarashi', 'Maraistan', 'John Doe', 'Kirt Renolds', 'Will RunOver', 'H Dizzie', 'Matt Kumiho', 'Michael Dennis Eagles', 'jack ryan', 'Joseph E Reid', 'Tailjaegar', 'Tiberumkyle', 'Cecil Kane', 'Matt Evans', 'DUSTIN MATTHEWS', 'Nikohalus G Ingraham', 'Joshua Smith', 'William Tomaszewski', 'Lys', 'Colby', 'qqq2', 'Alex McGregor', 'Guy Gower', 'concon361', 'Crazybue', 'Gwaxer', 'Ornithorhynchus', 'KnightSky', 'Tom Skelton', 'Alfredo J Sanchez', 'manshy', 'NC', 'andrew schumann', 'glocknar', 'Dragon_ANGL', 'William G Klett', 'kasper kass søderberg', 'Roman', 'stephen stricklin', 'ratking', 'Anthony', 'morraisen', 'Tazanik']
var ten = ["William Strable","Samantha Monroe","Raymoo","Nick Jenkins","Les Neckoway","klaas444","K. Nguyen","Joshua","John Foster","JEX","Ian Russell Lovie","Ghostfield",'Brown Man','Benjamin Choi','Alex Hernandez','Nikki Roberts','K. Nguyen','littlekingdeath','Augiedt', 'hedgewizard','Brett Giesbrecht','Brennen Nichols','Altan Tagrin','Diego Bank','CAke9000','Wandering Samurai','Aleksis Lindewall','Kind Phantom','Blue Oak','Benny Castillo','Neverstorm','Zetta Schoen','David Hall','Shaun Holmes','nate parrot','Ellenafy','Heimfjarl','Frenchi','Patch','Ineedmoney','Kriskon', 'Bla', 'EroCK', 'WinterFrailty', 'sarcasm2k1', 'Blacktouch', 'Benji Steel', 'Erin Howe', 'Lenrir','NovaShards', 'seira', 'richard','Les Neckoway']
var introtext = "The world of Acheron is going through a period of peace. What few local disputes between cities and regions emerge are quickly prevented and resolved by the major leading and governing force: The Mage's Order. The brightest, richest and most powerful people all aiming to join the most advanced organization out there. Of course, magic, mainly in the form of mind and body manipulations, is well-respected by the whole civilization and is controlled very strictly and scientifically. By utilizing it, The Mage's Order has managed to became what it is now. With it’s rise to power recruitment is now open to any who can prove themselves. Naturally, older members still carry the elitist attitude and look down on those who originate from lesser standing.\n\nWhile magic can be eventually learned and executed by anyone, everything comes at cost. Mana, the source of raw magic, can rarely be obtained directly from nature. The most dominant source for everyone's use is biological life. There are two generally acknowledged options for modern wizards to collect mana for their needs: pain and pleasure. Using other living beings as the source, they can extract and preserve their dormant magic energy either by inflicting wounds and pain, which makes them release accumulated mana, or by indulging in sexual activities, which proved to be nearly as effective at that. Both actions being very essential to life theorized to be a part of the existing great law of things which eventually made it possible for all live beings to form and connects them to this day. \n\nOn the other hand, the average person's survival proves to be hard even at these times of relative peace. Constant shortage of food in many regions and high birth rate makes it hard for many to find a reasonable place in society and as a result they end up becoming outlaws. For those who cannot provide for themselves, slavery has become common practice and is strictly regulated by the government. It serves as a reasonable option for many individuals who seek a better opportunity to their conditions. Slaves make an efficient option for mana gathering. "
...
func _ready():
	...
	var text = ''
	get_node("Container/warning").set_hidden(false)
...
func _on_load_pressed():
	get_node("TextureFrame/SavePanel").set_hidden(false)

func _on_credits_pressed():
	get_node("TextureFrame/creditpanel").set_hidden(false)

func _on_back_pressed():
	get_node("TextureFrame/NewGamePanel").set_hidden(true)

func _on_Button_pressed():
	get_node("TextureFrame/NewGamePanel").set_hidden(false)
...
func _on_creditsclose_pressed():
	get_node("TextureFrame/creditpanel").set_hidden(true)
...
func charcreateinitiate():
	...
	for i in get_tree().get_nodes_in_group("lookline"):
		i.connect("text_changed", self, 'looklinetext')
...
func advancestage(confirm = false):
	...
	if stage == 0:
		...
		get_node("TextureFrame/newgame/stage1").set_hidden(false)
	elif stage == 1:
		if sandbox == false:
			get_node("TextureFrame/introduction").set_hidden(false)
			get_node("TextureFrame/introduction/RichTextLabel").set_bbcode(introtext)
		get_node("TextureFrame/newgame/stage2").set_hidden(false)
	elif stage == 2:
		get_node("TextureFrame/newgame/stage3").set_hidden(false)
		stage3()
	elif stage == 3:
		get_node("TextureFrame/newgame/stage4").set_hidden(false)
		if sandbox == false:
			get_node("TextureFrame/introduction").set_hidden(false)
...
func _on_warnconf_pressed():
	player = null
	advancestage(true)
	get_node("TextureFrame/newgame/warn").set_hidden(true)
...
func _on_cancel_pressed():
	get_node("TextureFrame/newgame").set_hidden(true)
	self.stage = 0
	sandbox = false
...
func _on_closeintro_pressed():
	get_node("TextureFrame/introduction").set_hidden(true)
...
func _on_lookconfirm_pressed():
	if stage != 7:
		...
		get_node("TextureFrame/newgame/stage6").set_hidden(true)



func looklinetext(text):
	for i in get_tree().get_nodes_in_group("lookline"):
		player[i.get_name()] = i.get_text()
	stage5change()
...
"Servant" : "As traveling on your own might be dangerous, you decided to take your trusted servant, $name, who've been around for all your childhood and proven to be very dependant. ",
...
'Physical' : '[color=aqua]Strength: +1; +Courage[/color]\n\n$name is no stranger to fighting and tend to act boldly in many situations. ',
...
'Magic' : "[color=aqua]Magic: +2; +Wit[/color]\n\n$name was very curious child and spent lot of $his time reading and studying various things, including magic.",
