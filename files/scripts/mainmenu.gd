...
var ten = ['Benny Castillo','Neverstorm','Zetta Schoen','David Hall','Shaun Holmes','nate parrot','Ellenafy','Heimfjarl','Frenchi','Patch','Ineedmoney','Kriskon', 'Bla', 'EroCK', 'WinterFrailty', 'sarcasm2k1', 'Blacktouch']
...
func advancestage(confirm = false):
	...
	if stage == 0:
		...
		player = globals.slavegen.newslave(currentrace, currentage, currentsex, 'slave')
