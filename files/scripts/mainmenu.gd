...
var ten = ['Kind Phantom','Blue Oak','Benny Castillo','Neverstorm','Zetta Schoen','David Hall','Shaun Holmes','nate parrot','Ellenafy','Heimfjarl','Frenchi','Patch','Ineedmoney','Kriskon', 'Bla', 'EroCK', 'WinterFrailty', 'sarcasm2k1', 'Blacktouch']
