...
text2 = {consensual = 'nonconsensualdislike', pchaspenis = true, text = '$name averts $his eyes, as you position $him to have access to $his rear. Not waiting for long, you push cock inside of $his ass making $him yelp because of sudden invasion. $He tries to get away and break free but firmly grope his body in place. As you move inside of $his ass, tears falling down here cheeks and $he begs you to stop. $His desperation brings you closer to climax.'},
},
blowjob = {
text1 = {function = 'blowjobsex'},
text2 = {consensual = 'nonconsensualdislike', text = "You tightly tie $name in place. Brushing over $his cheek, you take a ring gag. After a moment you have fixated a gag on a $child mouth. You take off your pants and direct your cock into poor thing's face. $His clumsy attempts to evade it only provoke you further. With force you insert cock into an open mouth, making $child moan in protest. $His warm and damp tongue instinctively tries to push out the invader, but it only increases your pleasure. With glee you grabs the victim's head and start to move it. By every second you force yourself into $his throat deeper and deeper. By this time moans are replaced with whimper and cries while $his tear-stained eyes begin to express humility. You feel how that sight brings you closer to climax."},
},
hairjob = {
...
oral = {code = 'oral', name = 'Oral sex', actions = ['oral', 'blowjob','blowjobgive', 'oraltake', 'rimjob', 'rimjobgive'], cost = 25, description = "Oral sex is very stimulating and good for bringingat least one of the partners to orgasm.", prereq = ['petting'], number = 1, unlockdescript = "You talk $name into using their mouth for more than just kissing. "},
...
var normalscenes = {
'kiss': {
consensual = 'You deeply kiss $name and tightly hug $his body. $He responds to your embrace and takes notice pleasure from the contact. ',
